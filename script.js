...
/* ---------- Отзывы: стрелки горизонтальной ленты ----------
   ...
   в части движков и при включённом «уменьшить движение» smooth молча
   игнорируется — прокрутка не происходит вовсе, и кнопки выглядят
   сломанными. Позицию считаем абсолютную: при scrollBy шаги накапливают
   ошибку, если предыдущая анимация ещё идёт. */
(function () {
